...
if (isset($_POST['submit'])) {
	...
	if ($result->num_rows > 0) {
		...
		echo "<script>alert('Woops! Nombre de usuario o la contraseña estan mal :(.')</script>";
	}
}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../Biblioteca/Login2/css/style.css">
...
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<p class="login-register-text">¿No tienes una cuenta? <a href="register.php">Registrarme</a>.</p>
		</form>
	</div>
</body>
</html>